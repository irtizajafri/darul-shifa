...
const subModules = [
  ...
  { title: 'Asset Shifting',             icon: ArrowLeftRight, desc: 'Fixed assets ko ek location se doosri location pe shift karo',     stat: 'Shifting history ke saath',    path: '/inventory/asset-shifting', subModule: 'asset-shifting', altSubModule: 'maintenance' },
