  ...
  return (
    <div className="copd-crf">
      ...
      <div className="copd-crf-hdr">
        ...
        <div className="copd-crf-hdr-title">{departmentName.toUpperCase()} FORM</div>
      </div>
        ...
        <div className="copd-crf-col-left">
          <div className="copd-crf-box">
            ...
            <div className="copd-crf-box-body">
              <div>Patient Name: <span className="copd-crf-dln copd-crf-dln--full">{visit.patientName}</span></div>
              <div>
              ...
              <div>Contact No. <span className="copd-crf-dln copd-crf-dln--full">{visit.phoneNo}</span></div>
            </div>
          </div>
