...
export const PERMISSIONS_MAP = {
  ...
  inventory: {
    ...
    subModules: [
      ...
      { key: 'asset-shifting',  label: 'Asset Shifting' },
    ...
    subModules: [
      ...
      // ── Reports ──────────────────────────────────────────────────────────────
      {
        ...
        tabs: [
          ...
          { key: 'ward-wise-bill',                  label: 'Ward Wise Bill Report' },
          { key: 'statement-of-surgery',             label: 'Statement of Surgery' },
          { key: 'status-wise-admission',             label: 'Status Wise Admission' },
          { key: 'admission-distribution',            label: 'Admission Distribution' },
          { key: 'ward-wise-payment-distribution',    label: 'Ward Wise Payment Distribution' },
          { key: 'department-monthly-comparison',     label: 'Department wise Monthly Comparison' },
          { key: 'cancel-refund-history',              label: 'Cancel & Refund Slip History' },
          { key: 'doctor-schedule',                    label: 'Doctor Schedule Report' },
        ],
      },
