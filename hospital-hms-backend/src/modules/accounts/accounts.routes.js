...
router.get('/linked/inventory-items-for-head', ctrl.getInventoryItemsForHead);
router.post('/payee-head-linked-custom-heads', ctrl.linkCustomHeadToInventoryHead);
router.delete('/payee-head-linked-custom-heads/:headId/:customHeadId', ctrl.unlinkCustomHeadFromInventoryHead);
